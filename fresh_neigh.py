...
Original file is located at
    https://colab.research.google.com/drive/1z6TlSrQRh21ofMQmsQwOM7u5oI1MxLPl
"""
      ...
      if best.destination in i.neighbors:
        ...
        for k in i.neighbors:
          if k.vector[best.destination.id] > max_value:
            ...
            kaliteros = k
        if kaliteros != -2:
          #print(f"I am node {i.id} and I give packet {best.id} to my best neighbor {kaliteros.id}")
